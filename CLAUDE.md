...
- Preserve the contextual partner destinations and dated photographer-snapshot links documented in `STRUCTURE.md`; do not add any other outbound destination without explicit approval.
